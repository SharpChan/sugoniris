...
public class DataRinseServiceImpl implements DataRinseService {
    ...
    public void completeRinse(String userId,Long caseId) {
                ...
                String updateSql = "update  " +
                        ...
                        "set jyhm = (select zhkhmc from base_bank_zhxx_"+caseId+"_"+userId+" b where a.jykh =b.jykh and a.jyzh = b.jyzh  and b.zhkhmc is not null and trim(b.zhkhmc) != '') " +
                        "where a.jyzjhm is null or trim(a.jyzjhm) = ''";
