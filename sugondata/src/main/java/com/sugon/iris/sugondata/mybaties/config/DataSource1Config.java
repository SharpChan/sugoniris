package com.sugon.iris.sugondata.mybaties.config;
...
public class DataSource1Config {
    ...
    public SqlSessionFactory db1SqlSessionFactory(@Qualifier("db1DataSource") DataSource dataSource) throws Exception {
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:com/sugon/iris/sugoniris/datasources/mapper/db1xml/*.xml"));
